        ...
        return (
          ...
          >
            ...
            <div className="relative flex items-center justify-center w-20 h-20">
              {isActive && (
                <motion.div
                  /* MUST MATCH PCNav AND TabletNav EXACTLY */
                  layoutId="globalNavIndicator"
                  className="absolute inset-0 bg-Body rounded-full shadow-[0_15px_35px_rgba(0,0,0,0.4)] -translate-y-10"
            ...
            <span
              className={`
                absolute bottom-2 transition-all duration-500 text-sm font-bold tracking-wide
                ${isActive 
